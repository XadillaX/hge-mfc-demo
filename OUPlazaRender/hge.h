...
#ifdef OUPLAZARENDER_EXPORTS
#define OURENDER_EXPORT  __declspec(dllexport)
#else
#define OURENDER_EXPORT  __declspec(dllimport)
#endif
...
public:
    ...
    /** XadillaX+ */
    virtual void        CALL    AttachWindowsProc(WNDPROC proc) = 0;
};

extern "C" { OURENDER_EXPORT HGE * CALL hgeCreate(int ver); }
