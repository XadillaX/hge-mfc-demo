...
inline OURENDER_EXPORT hgeColorRGB operator* (const float sc, const hgeColorRGB &c) { return c*sc; }


class OURENDER_EXPORT hgeColorHSV
{
public:
	float		h,s,v,a;
...
inline OURENDER_EXPORT hgeColorHSV operator* (const float sc, const hgeColorHSV &c) { return c*sc; }
